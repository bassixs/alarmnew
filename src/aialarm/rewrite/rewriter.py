...
- Первая строка — самостоятельный ясный заголовок с сутью и местом, когда оно известно.
  Не используй кликбейт, абстрактные «важные новости» и служебные заголовки.
- Первый абзац сразу отвечает на вопросы «что, где и когда»: например, при отключениях,
  работах, изменении маршрута или расписания сначала назови дату/время и конкретное место.
  Затем коротко объясни причину и что будет дальше.
- Далее 1–3 коротких абзаца с важными деталями: цифрами, адресами, сроками и действиями,
  которые нужны читателю. Не повторяй одни и те же сведения разными словами.
...
- Убирай обращения вроде «уважаемые жители», общие вводные фразы, канцелярит и эмоциональные
  оценки. Не пиши «в рамках», «в целях», «данное мероприятие», «осуществляется» — замени их
  обычными понятными словами. Без рекламного тона и предположений.
...
- Эмодзи не обязательны. Если помогают быстро считать смысл заголовка, используй один уместный
  (например, ℹ️ для объявления), но не украшай ими каждую новость.
